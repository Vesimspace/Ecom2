$(document).ready(function(){
        ...
        $.ajax({
			...
			success:function(res){
                ...
                if (_totalShowing == _total){
                    $("#loadMore").remove(); // To remove loading button after clicked on it
                }
			}
		});
    });
    ...
    $(".choose-color").on('click', function(){  // Shows the size according to the color
        $(".choose-color").removeClass('clicked-blue'); // clicked-blue -> custom.css
        $(this).addClass('clicked-blue');
    ...
    $(".choose-color").first().addClass('clicked-blue');
    var _color = $(".choose-color").first().attr('data-color'); // Shows the first color
    var _price = $(".choose-size").first().attr('data-price'); 
	...
	$(document).on('click',".add-to-cart",function(){
		...
		$.ajax({
			...
			success:function(res){
				$(".cart-number").text(res.totalitems);
